...
# ddiffuseNet, dspecularNet, dlDiff, dlSpec, dlFinal = train(dataset, input_channels, device, mode='DPCN', epochs=40, learning_rate=1e-5)
...
kdiffuseNet, kspecularNet, klDiff, klSpec, klFinal = train(dataset, input_channels, device, mode='KPCN', epochs=40, learning_rate=1e-5)
